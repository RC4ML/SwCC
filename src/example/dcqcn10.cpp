...
int main() {
    ...
    for(int i=0;i<1024;i++){
        ...
        std::cout<< i*32 ; 
        fmt::println("REG_BUCKET_VALUE   : {}", fpga_ctl->readReg(512+340));        
    }
...
fmt::println("mac_ip_encode.handle_arp_reply1.io.data_in.[fire]           : {}", fpga_ctl->readReg(512+476));
fmt::println("mac_ip_encode.handle_arp_reply1.io.data_out.[fire]          : {}", fpga_ctl->readReg(512+477));
fmt::println("arp.arp_table.io.arpinsert.[fire]                           : {}", fpga_ctl->readReg(512+478));
fmt::println("arp.arp_table.io.arpinsert1.[fire]                          : {}", fpga_ctl->readReg(512+479));
fmt::println("arp.arp_table.io.arp_req1.[fire]                            : {}", fpga_ctl->readReg(512+480));
fmt::println("arp.arp_table.io.arp_rsp1.[fire]                            : {}", fpga_ctl->readReg(512+481));
fmt::println("arp.arp_table.io.arp_req2.[fire]                            : {}", fpga_ctl->readReg(512+482));
fmt::println("arp.arp_table.io.arp_rsp2.[fire]                            : {}", fpga_ctl->readReg(512+483));

//Report width 1:
fmt::println("fifo_c2h_cmd.io.out.valid                                   : {}", (fpga_ctl->readReg(512+484) >> 0) & 1);
fmt::println("fifo_c2h_cmd.io.out.ready                                   : {}", (fpga_ctl->readReg(512+484) >> 1) & 1);
fmt::println("fifo_h2c_cmd.io.out.valid                                   : {}", (fpga_ctl->readReg(512+484) >> 2) & 1);
fmt::println("fifo_h2c_cmd.io.out.ready                                   : {}", (fpga_ctl->readReg(512+484) >> 3) & 1);
fmt::println("fifo_c2h_data.io.out.valid                                  : {}", (fpga_ctl->readReg(512+484) >> 4) & 1);
fmt::println("fifo_c2h_data.io.out.ready                                  : {}", (fpga_ctl->readReg(512+484) >> 5) & 1);
fmt::println("fifo_h2c_data.io.in.valid                                   : {}", (fpga_ctl->readReg(512+484) >> 6) & 1);
fmt::println("fifo_h2c_data.io.in.ready                                   : {}", (fpga_ctl->readReg(512+484) >> 7) & 1);
fmt::println("rx_dispatch.io.drop_meta_out.ready                          : {}", (fpga_ctl->readReg(512+484) >> 8) & 1);
fmt::println("rx_dispatch.io.cc_meta_out.ready                            : {}", (fpga_ctl->readReg(512+484) >> 9) & 1);
fmt::println("rx_dispatch.io.dma_meta_out.ready                           : {}", (fpga_ctl->readReg(512+484) >> 10) & 1);
fmt::println("rx_dispatch.io.event_meta_out.ready                         : {}", (fpga_ctl->readReg(512+484) >> 11) & 1);
fmt::println("mac_ip_encode.handle_arp_reply1.arp_miss                    : {}", (fpga_ctl->readReg(512+484) >> 12) & 1);
fmt::println("ip_handler.route_by_eth1.<route_by_eth_overflow>[trigger]   : {}", (fpga_ctl->readReg(512+484) >> 13) & 1);
fmt::println(".<iptest_rx_buffer_almostfull>[trigger]                     : {}", (fpga_ctl->readReg(512+484) >> 14) & 1);
